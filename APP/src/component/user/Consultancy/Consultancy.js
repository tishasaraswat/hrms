...
import ModalBox from '../../user/Consultancy/EditConsultancy'                  //for Edit             
...
const Consultancy = () =>{
    //working for states-----------------
        ...
        useEffect(() => {
            const fetchData = async () => {                            //
                try {
                    const response = await axios.get(`${BASE_API_URL}consultancy/findconsultancy`);            //axios use for showing data frome server side
    ...
    const Deletemulti = async () => {
        ...
        try {
            const response = await axios.delete(`${BASE_API_URL}consultancy/deletmanyconsultancy`, {            //BASE_API_URL= dynamic data ko fetch krne ke liye
    ...
    const validateForm = () => {
        ...
        if (!formData.consultancy_name.trim()) {              //whide space htane ke liye
    ...
    const handleChange = async (event) => {
        ...
        if (event.target.value !== '') {
            ...
            try {
                const response = await axios.get(`${BASE_API_URL}consultancy/findconsultancy`);
                console.log(response.data.data); // Handle the response as needed
                settableData(response.data.data)
            } catch (error) {
                console.error('Error:', error);
 ...
 {/* WELCOME TO CONSULTANCY PAGE (current state) */}
                                                 ...
                                                 <form onSubmit={handleSubmit} class="mt-5 border p-4 bg-light shadow">
                                                     ...
                                                     <div class="row">
                                                         ...
                                                         <label><b>Name</b></label>
                                                             ...
                                                             <input type="text" name="consultancy_name" value={formData.consultancy_name} onChange={handleInputChange} class="form-control" placeholder="First Name" />
                                                         ...
                                                         <label><b>Email</b></label>
                                                             ...
                                                             <input type="email" name="consultancy_email" value={formData.consultancy_email} onChange={handleInputChange} class="form-control" placeholder="Email" />
                                                         ...
                                                         <label><b>Website</b></label>
                                                             ...
                                                             <input type="text" name="consultancy_website" value={formData.consultancy_website} onChange={handleInputChange} class="form-control" placeholder="Website" />
                                                         </div>

                                                         <div class="mb-3 col-md-6">
                                                         <label><b>Mobile No.</b></label>

                                                             <input type="text" name="consultancy_mobile" value={formData.consultancy_mobile} onChange={handleInputChange} class="form-control" placeholder="Mobile" />
                                                         </div>

                                                         <div class="mb-3 col-md-6">
                                                         <label><b>Alternate Mobile</b></label>

                                                             <input type="text" name="consultancy_alternate_mobile" value={formData.consultancy_alternate_mobile} onChange={handleInputChange} class="form-control" placeholder="Aletnate Mobile" />
                                                         </div>
                                                         ...
                                                         <label><b>Details</b></label>
                                                             ...
                                                             <input type="text" name="consultancy_details" value={formData.consultancy_details} onChange={handleInputChange} class="form-control" placeholder="Details" />
                                                         </div>
...
<th scope="col" onClick={() => handleSort('consultancy_name')}>NAME {sortColumn === 'consultancy_name' && (            //for sorting
